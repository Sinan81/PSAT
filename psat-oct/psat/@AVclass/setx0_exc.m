...
if idx
  Te(idx) = 1;
  a.con(idx,10) = 1;
  warn_exc(a,idx,[' Te is negative or zero. ', ...
...
if idx
  Tr(idx) = 0.001;
  a.con(idx,11) = 0.001;
  warn_exc(a,idx,[' Tr is negative or zero. ', ...
...
if ty1
  ...
  Ce = -vf(ty1) -  ceiling_exc(a,vf(ty1),A,B,1);
  m0 = a.con(ty1,5);
  T1 = a.con(ty1,6);
  T2 = a.con(ty1,7);
  T3 = a.con(ty1,8);
  ...
  if idx
    m0(idx) = 400;
    a.con(ty1(idx),5) = 400;
    warn_exc(a,ty1(idx), [' m0 cannot be zero. ', ...
  ...
  if idx
    T1(idx) = 0.1;
    a.con(ty1(idx),6) = 0.1;
    warn_exc(a,ty1(idx), [' T1 cannot be zero. ', ...
  ...
  if idx
    ...
    warn_exc(a,ty1(idx), [' T4 cannot be zero. ', ...
  ...
  if idx
    check = 0;
    warn_exc(a,ty1(idx),' Vr is over its max limit.')
  end
  idx = find(vr < vrmin(ty1));
  if idx
    check = 0;
    warn_exc(a,ty1(idx),' Vr is under its min limit.')
  end
end
...
if ty2
  ...
  if idx
    a.con(ty2(idx),9) = 1;
    Ke(idx) = 1;
    warn_exc(a,ty2(idx),[' Ke cannot be zero. ', ...
	    'Default value Ke = 1 will be used.'])
  end
  %Ce = vf(ty2).*(1+A.*(exp(B.*abs(vf(ty2)))-1));
  Ce = Ke.*vf(ty2) + ceiling_exc(a,vf(ty2),A,B,1);
  Ka = a.con(ty2,5);
  Ta = a.con(ty2,6);
  Kf = a.con(ty2,7);
  Tf = a.con(ty2,8);
  ...
  if idx
    Tf(idx) = 0.1;
    a.con(ty2(idx),8) = 0.1;
    warn_exc(a,ty2(idx),[' Tf cannot be zero. ', ...
	    'Default value Tf = 0.1 will be used.'])
  end
  idx = find(Ta <= 0);
  if idx
    a.con(ty2(idx),6) = 0.1;
    warn_exc(a,ty2(idx),[' Ta cannot be zero. ', ...
  ...
  if idx
    check = 0;
    warn_exc(a,ty2(idx),' Vr1 is over its max limit.')
  end
  idx = find(Ce < vrmin(ty2));
  if idx
    check = 0;
    warn_exc(a,ty2(idx),' Vr1 is under its min limit.')
  end
end
...
if ty3
  ...
  if idx
    a.con(ty3(idx),6) = 0.1;
    warn_exc(a,ty3(idx),[' T2 cannot be zero. ', ...
	    'Default value T2 = 0.1 will be used.'])
  end
  idx = find(vf((ty3)) > vrmax(ty3));
  if idx
    check = 0;
    warn_exc(a,ty3(idx),' Vf is over its max limit.')
  end
  idx = find(vf(ty3) < vrmin(ty3));
  if idx
    check = 0;
    warn_exc(a,ty3(idx),' Vf is under its min limit.')
  end
end
