...
if ty1
  ...
  DAE.Fx = DAE.Fx - sparse(p.vf(ty1),p.vf(ty1),(1+ceiling_exc(p,vf,A(ty1),B(ty1),2))./Te(ty1),DAE.n,DAE.n);
...
if ty2
  ...
  DAE.Fx = DAE.Fx - sparse(p.vf(ty2),p.vf(ty2),(Ke+ceiling_exc(p,vf,A(ty2),B(ty2),2))./Te(ty2),DAE.n,DAE.n);
