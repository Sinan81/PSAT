...
bdmatrix_exc(Exc);      % define LA.b_avr       LA.d_avr
bdmatrix_tg(Tg);       % define LA.b_tg        LA.d_tg
bdmatrix_svc(Svc);      % define LA.b_svc       LA.d_svc
bdmatrix_tcsc(Tcsc);     % define LA.b_tcsc      LA.d_tcsc
bdmatrix_statcom(Statcom);  % define LA.b_statcom   LA.d_statcom
bdmatrix_sssc(Sssc);     % define LA.b_sssc      LA.d_sssc
bdmatrix_upfc(Upfc);     % define LA.b_upfc      LA.d_upfc
bdmatrix_hvdc(Hvdc);     % define LA.b_hvdc      LA.d_hvdc
...
hmatrix_line(Line); % define LA.h_ps LA.h_qs LA.h_is
