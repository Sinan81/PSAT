...
if ~isempty(is3)
  ...
  DAE.f(a.e1q(is3)) = -a34.*synsat_syn(a,1,e1q(is3),is3) - a35.*a.Id(is3) + a34.*Vf(is3);
end
...
if ~isempty(is4)
  ...
  DAE.f(a.e1q(is4)) = -a44.*synsat_syn(a,1,e1q(is4),is4) - a45.*a.Id(is4) + a44.*Vf(is4);
...
if ~isempty(is51)
  ...
  DAE.f(a.e1q(is51)) = -a514.*synsat_syn(a,1,e1q(is51),is51) - a515.*a.Id(is51) + a514.*Vf(is51);
...
if ~isempty(is52)
  ...
  DAE.f(a.e1q(is52)) = -a524.*synsat_syn(a,1,e1q(is52),is52) - a525.*a.Id(is52) + a526.*Vf(is52);
...
if ~isempty(is6)
  ...
  DAE.f(a.e1q(is6)) = -a4.*synsat_syn(a,1,e1q(is6),is6) - a5.*a.Id(is6) + a6.*Vf(is6);
...
if ~isempty(is8)
  ...
  DAE.f(a.e1q(is8)) = -a48.*synsat_syn(a,1,e1q(is8),is8) - a58.*a.Id(is8) + a68.*Vf(is8);
