...
if (~isempty(is3))
  ...
  DAE.Fx = DAE.Fx - sparse(e1q3,e1q3,a34.*synsat_syn(a,2,e1q(is3),is3)+a35.*a.c3(is3)+(~a.u(is3)),DAE.n,DAE.n);
...
if ~isempty(is4)
  ...
  DAE.Fx = DAE.Fx - sparse(e1q4,e1q4,a44.*synsat_syn(a,2,e1q(is4),is4)+a45.*a.c3(is4)+(~a.u(is4)), DAE.n,DAE.n);
...
if(~isempty(is51))
  ...
  DAE.Fx = DAE.Fx - sparse(e1q51,e1q51,a514.*synsat_syn(a,2,e1q(is51),is51)+a515.*a.c3(is51)+(~a.u(is51)),DAE.n,DAE.n);
...
if(~isempty(is52))
  ...
  DAE.Fx = DAE.Fx - sparse(e1q52,e1q52,a524.*synsat_syn(a,2,e1q(is52),is52)+(~a.u(is52)),DAE.n,DAE.n);
...
if(~isempty(is6))
  ...
  DAE.Fx = DAE.Fx - sparse(e1q6,e1q6,a4.*synsat_syn(a,2,e1q(is6),is6)+(~a.u(is6)),DAE.n,DAE.n);
...
if ~isempty(is8)
  ...
  DAE.Fx = DAE.Fx - sparse(e1q8,e1q8,a48.*synsat_syn(a,2,e1q(is8),is8)+(~a.u(is8)),DAE.n,DAE.n);
