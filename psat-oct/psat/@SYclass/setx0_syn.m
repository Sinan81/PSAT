...
if ~isempty(idx)
  ...
  warn_syn(a,idx,' Inertia cannot be <= 0. M = 10 [kWs/kVa] will be used.')
end
idx = find(a.con(:,9) <= 0);
if ~isempty(idx)
  a.con(idx,9) = 0.302;
  ...
  warn_syn(a,idx,' x''d cannot be <= 0. x''d = 0.302 [p.u.] will be used.')
end
...
if ~isempty(idx)
  ...
  warn_syn(a,idx,' xd cannot be <= 0. xd = 1.90 [p.u.] will be used.')
end
idx = find(a.con(is,11) <= 0);
if ~isempty(idx)
  idx = is(idx);
  a.con(idx,11) = 8.00;
  warn_syn(a,idx,' T''d0 cannot be <= 0. T''d0 = 8.00 [s] will be used.')
end
...
if ~isempty(idx)
  idx = is(idx);
  a.con(idx,12) = 0.04;
  warn_syn(a,idx,' T"d0 cannot be <= 0. T"d0 = 0.04 [s] will be used.')
end
...
if ~isempty(idx)
  ...
  warn_syn(a,idx,' x"d cannot be <= 0. x"d = 0.204 [p.u.] will be used.')
end
...
if ~isempty(idx)
  ...
  warn_syn(a,idx,' x"q cannot be <= 0. x"q = 0.30 [p.u.] will be used.')
end
% check T'q0
is = [is4; is51; is6; is8];
...
if ~isempty(idx)
  idx = is(idx);
  a.con(idx,16) = 0.80;
  warn_syn(a,idx,' T''q0 cannot be <= 0. T''q0 = 0.80 [s] will be used.')
end
% check T"q0
...
if ~isempty(idx)
  idx = is(idx);
  a.con(idx,17) = 0.02;
  warn_syn(a,idx,' T"q0 cannot be <= 0. T"q0 = 0.02 [s] will be used.')
end
% check xq
is = [is3; is4; is51; is52; is53; is6; is8];
...
if ~isempty(idx)
  ...
  warn_syn(a,idx,' xq cannot be <= 0. xq = 1.70 [p.u.] will be used.')
end
% check x'q
is = [is4; is51; is6; is8];
...
if ~isempty(idx)
  ...
  warn_syn(a,idx,' x''q cannot be <= 0. x''q = 0.50 [p.u.] will be used.')
end
...
if ~isempty(is3)
  ...
  a.vf0(is3) = synsat_syn(a,1,DAE.x(a.e1q(is3)),is3)+(xd(is3)-xd1(is3)).*a.Id(is3);
end
if ~isempty(is4)
  ...
  a.vf0(is4) = synsat_syn(a,1,DAE.x(a.e1q(is4)),is4)+ ...
...
if ~isempty(is51)
  ...
  DAE.x(a.e1d(is51)) = (xq(is51)-xq1(is51)- ...
                          ...
                          xq1(is51)).*a.Iq(is51);
  a.vf0(is51) = synsat_syn(a,1,DAE.x(a.e1q(is51)),is51)+ ...
...
if ~isempty(is52)
  ...
  a.vf0(is52) = (k1.*a.Id(is52)+synsat_syn(a,1,DAE.x(a.e1q(is52)),is52))./ ...
...
if ~isempty(is6)
  ...
  a.vf0(is6) = (k1.*a.Id(is6)+synsat_syn(a,1,DAE.x(a.e1q(is6)),is6))./ ...
      (1-Taa(is6)./Td10(is6));
end
if ~isempty(is8)
  ...
  a.vf0(is8) = (k1.*a.Id(is8)+synsat_syn(a,1,DAE.x(a.e1q(is8)),is8))./ ...
      (1-Taa(is8)./Td10(is8));
