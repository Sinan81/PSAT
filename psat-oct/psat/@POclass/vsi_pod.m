...
if SIPs, Ps = pjflows_line(Line,1,a.idx(SIPs),1); end
if SIPr, Pr = pjflows_line(Line,2,a.idx(SIPr),1); end
if SIIs, Is = pjflows_line(Line,3,a.idx(SIIs),1); end
if SIIr, Ir = pjflows_line(Line,4,a.idx(SIIr),1); end
if SIQs, Qs = pjflows_line(Line,5,a.idx(SIQs),1); end
if SIQr, Qr = pjflows_line(Line,6,a.idx(SIQr),1); end
