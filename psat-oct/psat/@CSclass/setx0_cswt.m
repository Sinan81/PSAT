...
for i = 1:a.n
  ...
  while abs(eqnvw) > 1e-8
    ...
    eqnvw = windpower_cswt(a,rho(i),vw,A,R,DAE.x(a.omega_m(i)),1,1)-Pw*Settings.mva*1e6;
    jacvw = windpower_cswt(a,rho(i),vw,A,R,DAE.x(a.omega_m(i)),1,2);
    incvw = -eqnvw/jacvw(2);
