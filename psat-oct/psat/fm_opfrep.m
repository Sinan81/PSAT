...
if OPF.enflow
  Iijmax = getflowmax_line(Line,OPF.flow);
else
...
if OPF.init == 2
  ...
  if OPF.line
    ...
    Line = setstatus_line(Line,OPF.line,0);
  end
  [Iijc,Ijic] = flows_line(Line,OPF.flow);
  if OPF.line
    Line = setstatus_line(Line,OPF.line,status);
  end
  DAE.y = yold;
end
