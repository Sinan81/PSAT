...
if idx,
  a.con(idx,6) = 0.01;
  warn_pss(a,idx,[' Tw cannot be zero. Default value Tw = 0.01 will' ...
              ' be used.'])
end
if ty1
...
if tya
  ...
  if idx,
    ...
    warn_pss(a,idx,[' T2 cannot be zero. Default value T2 = 0.01 will' ...
                ' be used.'])
  end
  idx = find(T4(tya) == 0);
  if idx,
    a.con(tya(idx),11) = 0.01;
    warn_pss(a,idx,[' T4 cannot be zero. Default value T4 = 0.01 will' ...
                ' be used.'])
  end
...
if tyb
  ...
  if idx,
    ...
    warn_pss(a,idx,[' Ta cannot be zero. Default value Ta = 0.01 will' ...
                ' be used.'])
  end
  DAE.x(a.va(tyb)) = 0;
end
